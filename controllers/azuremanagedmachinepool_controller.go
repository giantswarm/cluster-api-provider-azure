...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=azuremanagedmachinepools/status;azuremanagedmachinepools/finalizers,verbs=get;update;patch
