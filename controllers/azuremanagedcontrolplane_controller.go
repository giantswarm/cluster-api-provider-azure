...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=azuremanagedcontrolplanes/status;azuremanagedcontrolplanes/finalizers,verbs=get;update;patch
